                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('services.update', $service->id) }}">
                            ...
                            <div class="form-group row">
                                <label for="type_card"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Name Type') }}</label>

                                <div class="col-md-6">
                                    <input id="type_card" type="text"
                                        class="form-control @error('name') is-invalid @enderror" name="type_card"
                                        value="{{ old('type_card', $service->type_card) }}" required
                                        autocomplete="type_card" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="last" type="text"
                                        ...
                                        value="{{ old('last', $service->last) }}" required
                                        autocomplete="last" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="description"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Some Description') }}</label>
