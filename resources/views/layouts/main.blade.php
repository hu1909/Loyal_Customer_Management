...
<head>
    ...
    <link href="{{ asset('css/decorate.css') }}" rel="stylesheet">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gray-800 sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/employees">
                    <span>Loyal Customer Management</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSystem" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('histories.index')}}">History</a>
    ...
    <script src="{{ asset('js/decorate.js') }}"></script>
